...
```
You may also want to add additional GraniteDS artifacts, such as granite-hibernate, etc.  You can see the entire list <a href="http://download.java.net/maven/2/org/graniteds/">here</a>.
