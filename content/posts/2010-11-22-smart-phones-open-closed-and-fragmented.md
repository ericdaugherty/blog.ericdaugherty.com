---
title: "Smart phones: Open, Closed, and Fragmented"
date: 2010-11-22T20:30:00Z
url: /2010/11/smart-phones-open-closed-and-fragmented.html
draft: false
---
Android is Open, iOS is closed.&nbsp; Well, that is one way to look at it.&nbsp; Steve Jobs would prefer: <a href="http://digitaldaily.allthingsd.com/20101018/jobs-on-android-the-fight-isnt-closed-vs-open-but-integrated-vs-fragmented/">Integrated vs. Fragmented</a>.&nbsp; As we've learned from politics, (Estate Tax vs. Death Tax), how you name something can dramatically change people's perceptions.
...
Apple takes a very controlling closed/integrated approach.&nbsp; You can only publish an application on an iPhone if Apple approves it.&nbsp; The approval process can be opaque at times, though it is getting better.&nbsp; As Henry Ford said: <a href="http://en.wikipedia.org/wiki/Henry_Ford">"Any customer can have a car painted any colour that he wants so long as it is black"</a>; the iPhone comes in one color, one screen size, one form factor.&nbsp; Old devices are supported for a while with the latest OS, but users are certainly encouraged to run the latest OS, with a somewhat recent version of the hardware.
