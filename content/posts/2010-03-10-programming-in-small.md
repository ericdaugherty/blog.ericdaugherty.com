...
draft: false
---
I believe that successful application development today is about 'tweaks and sub-features', not major functionality.&nbsp; But my thought process for this post was kicked off by an interesting post by Mike Taylor: '<a href="http://reprog.wordpress.com/2010/03/03/whatever-happened-to-programming/">Whatever happened to programming?</a>' Mike laments the evolution of programming.&nbsp; He is nostalgic for the day when writing a program was about creating something from scratch, instead of assembling the various pieces.
