...
The problem is, people see computers (Windows, OS X, iPhones, etc) for what they are, multi-purpose devices.  They figure out how they work and take advantage of undocumented features.  This has been going on for years with Windows, and as regular readers of <a href="http://blogs.msdn.com/oldnewthing/">The Old New Thing</a> blog know, Microsoft has made plenty of 'hacks' to their operating system to support applications that leveraged 'undocumented features'.  This brings up the two different approaches that exist at Microsoft and Apple.
